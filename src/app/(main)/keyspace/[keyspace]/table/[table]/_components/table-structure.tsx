...
export default function TableStructure({table}: TableStructureProps) {
    return (
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            {table?.clusteringKeys.includes(column.name) && (
                                                <Badge variant="secondary"
                                                    ...
                                                    Clustering { table?.clusteringOrder.find(({name}) => name === column.name)?.order }
                                                </Badge>
                                            )}
                                        </div>
                                    </TableCell>
                    ...
                    <CardContent>
                        <div className="space-y-1">
                            ...
                            <SettingItem
                                ...
                                label="Compression"
                                value={table.options.compression.sstable_compression.split('.').pop()}
                            />
                            <SettingItem
